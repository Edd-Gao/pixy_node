...
//initial min and max HSV filter values. //H��ɫ�� S�����Ͷ� V������
...
//max number of objects to be detected in frame   ���Ա�̽�⵽������
const int MAX_NUM_OBJECTS=50;
//minimum and maximum object area   ������������Χ
...
//The following for canny edge detec ��Ե����
...
{//This function gets called whenever a
	// trackbar position is changed   ���û�����
...
void createTrackbars(){
	//create window for trackbars �����л������Ĵ���
	...
	//3 parameters are: the address of the variable(ֵ�ĵ�ַ) that is changing when the trackbar���������� is moved(eg.H_LOW),
...
void morphOps(Mat &thresh){
	...
	//create structuring element that will be used to "dilate" and "erode" image.��̬ѧ�����ͺ͸�ʴ����,����ʹ�������������γ�һ�����壬������������erode��dilate
		...
		if(numObjects<MAX_NUM_OBJECTS)
		{
			for (int index = 0; index >= 0; index = hierarchy[index][0])
			{
				...
				if(area>MIN_OBJECT_AREA)
				{
					...
					object_x_cor[index] = moment.m10/area;
					object_y_cor[index] = moment.m01/area;
			...
			if(objectFound ==true)
			{
				...
				drawObject(objects,cameraFeed);//��һ�У�����Ļ����ʾ�Ѿ������õĵ�������

				for(unsigned int i = 0;i < objects.size();i++){
					locationx = objects[i].getXPos();
					locationy = objects[i].getYPos();
				}
			}
		}
...
int main(int argc, char* argv[])
{
	...
	//video capture object to acquire webcam feedͼ����ȡ
